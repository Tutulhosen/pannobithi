...
<a class="btn btn-success" href="{{route('category.page')}}">+ Create New Category</a>
   <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                              <div style="display: flex; gap: 10px;">
                                  <a href="{{ route('category.update.page', $category->id) }}" style="display: flex; justify-content: center; align-items: center; height: 30px; width: 30px; border-radius: 50%; background-color: rgb(125, 168, 209);">
